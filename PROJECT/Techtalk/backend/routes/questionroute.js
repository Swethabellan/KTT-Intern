...
const {getQuestions,createQuestion,getTotalQuestions,getAnsweredQuestions,getUnansweredQuestions,getTotalUsers,getAdminsideQuestions,updateQuestiontoggle}=require('../controllers/questionController');


router.post('/',authenticateToken,createQuestion);
router.get('/',authenticateToken,getQuestions);
router.get('/total-questions',authenticateToken,getTotalQuestions);
router.get('/answered-questions',authenticateToken,getAnsweredQuestions);
router.get('/unanswered-questions',authenticateToken,getUnansweredQuestions);
router.get('/total-users',authenticateToken,getTotalUsers);
router.get('/questions',authenticateToken,getAdminsideQuestions);
router.put('/:id/toggle-active',authenticateToken,updateQuestiontoggle);
